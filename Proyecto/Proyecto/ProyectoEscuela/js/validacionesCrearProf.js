function validaNombreProfCrear() {
...
function validaApellidoProfCrear() {
...
function validaContratacionProfCrear() {
    ...
    if (fechaIngresada >  fechaActual) {
        error.innerHTML = "La fecha de contratación no puede ser posteriorw a la fecha actual";
    } else {
...
function validaSalarioProfCrear() {
    ...
    if (!salario || salario.trim().length === 0) {
        ...
        error.innerHTML = "El formato del salario no es válido";
